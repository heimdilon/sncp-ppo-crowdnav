...
TRAINING_TOKENS = (
    ...
    "LR = 1e-4",
    "SAVE_PATH = 'checkpoints/sncp_ppo_v29.pt'",
...
EVALUATION_TOKENS = (
    "CHECKPOINT = 'checkpoints/sncp_ppo_v29.pt'",
    "EVAL_OUT = 'eval_v29'",
    "EVAL_SEED = 100",
    "EVAL_EPISODES = 50",
    "run_post_eval.py",
...
def verify_v16_run_ready(repo_root: str | Path = ".") -> V16RunReadinessSummary:
    ...
    _check_tokens(training_cell, TRAINING_TOKENS, notes, "v29 training")
    _check_tokens(evaluation_cell, EVALUATION_TOKENS, notes, "v29 evaluation")

    densities = _baseline_densities(repo_root / "eval_v22" / "density_sweep.json", notes)
    if not notes:
        notes.append("PASS: v29 Colab training and evaluation configuration is ready")
