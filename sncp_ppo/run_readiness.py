...
# v34 (redo) = v30 base (pre-MLP + mean+max + density curriculum, --num_humans_range 10 20,
# --total_steps 2_500_000) + Beta action distribution with TUNED entropy
# (--action_dist beta --ent_coef 0.001). Clean single-variable Beta ablation, now on the FIXED
# vectorized PPO path (the original v34 trained Normal(alpha,beta); make_action_dist fixes it).
TRAINING_TOKENS = (
    "NUM_ENVS = 16",
    "HORIZON = 128",
