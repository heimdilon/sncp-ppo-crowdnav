...
def test_v27_run_readiness_passes_current_repo():
...
def test_v27_run_readiness_flags_stale_notebook(tmp_path):
    # A pre-v27 notebook (v23/v24/v25/v26 markers) must be flagged: the v27 cells are absent.
    notebook = {
        "cells": [
            {
                "cell_type": "code",
...
def test_colab_persist_cell_downloads_eval_v27_artifact_bundle():
